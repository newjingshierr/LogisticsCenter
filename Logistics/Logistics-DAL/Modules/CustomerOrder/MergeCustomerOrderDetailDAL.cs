...
namespace Logistics_DAL
{
    public class MergeCustomerOrderDetailDAL
    {
        ...
        public static bool UpdateList(List<logistics_customer_order_merge_detail> detailList, AkmiiMySqlTransaction trans = null)
        {
            bool result = true;
            foreach (var d in detailList)
            {
        ...
        public static List<logistics_customer_order_merge_detail> GetList(long customerOrderMergeID, long TenantID = BusinessConstants.Admin.TenantID)
        {
            var result = new List<logistics_customer_order_merge_detail>();
